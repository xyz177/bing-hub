...
game.StarterGui:SetCore("SendNotification", {
Title = "Bing Hub";
Text = "SCP: Stranded [Horror Survival]";
Duration = 4;
})
wait(5)
...
if game.PlaceId == (12828227139) then
game.StarterGui:SetCore("SendNotification", {
Title = "Bing Hub";
Text = "War Machines";
Duration = 4;
...
if game.PlaceId == (8939045894) or game.PlaceId == (12545349775) then
game.StarterGui:SetCore("SendNotification", {
Title = "Bing Hub";
Text = "The Intruder";
Duration = 4;
...
if game.PlaceId == (6161235818) or game.PlaceId == (14170731342) then
game.StarterGui:SetCore("SendNotification", {
Title = "Bing Hub";
Text = "Twisted";
Duration = 4;
